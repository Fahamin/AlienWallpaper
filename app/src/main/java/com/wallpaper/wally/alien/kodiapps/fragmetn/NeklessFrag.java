...
import com.wallpaper.wally.alien.kodiapps.viewmodel.NecklessViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.neklessF;

public class NeklessFrag extends Fragment {

    private NecklessViewModel mViewModel;
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;

    public static NeklessFrag newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.neckless_fragment, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(NecklessViewModel.class);
        // TODO: Use the ViewModel
    }

    private void loadData() {
        neklessF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
