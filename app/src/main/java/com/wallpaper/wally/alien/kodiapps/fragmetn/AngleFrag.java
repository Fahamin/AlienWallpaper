...
import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.angleF;

public class AngleFrag extends Fragment {
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;
    private AngleViewModel mViewModel;

    public static AngleFrag newInstance() {
    ...
    private void loadData() {
        angleF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AngleViewModel.class);
