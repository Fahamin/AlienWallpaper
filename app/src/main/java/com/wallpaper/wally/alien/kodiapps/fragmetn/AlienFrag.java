...
public class AlienFrag extends Fragment {
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    private AlienViewModel mViewModel;
    ImageAdapter adapter;

    public static AlienFrag newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.alien_fragment, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mViewModel = ViewModelProviders.of(this).get(AlienViewModel.class);
