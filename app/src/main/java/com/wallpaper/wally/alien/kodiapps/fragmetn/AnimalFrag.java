...
import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.animalF;

public class AnimalFrag extends Fragment {
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;
    private AnimalViewModel mViewModel;

    public static AnimalFrag newInstance() {
    ...
    private void loadData() {
        animalF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AnimalViewModel.class);
