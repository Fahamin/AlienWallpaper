...
import com.wallpaper.wally.alien.kodiapps.viewmodel.ScifiViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.scifiF;

public class ScifiFrag extends Fragment {

    private ScifiViewModel mViewModel;
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;
    public static ScifiFrag newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.scifi_fragment, container, false);
    }
    ...
    private void loadData() {
        scifiF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(ScifiViewModel.class);
