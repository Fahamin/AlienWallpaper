...
import com.wallpaper.wally.alien.kodiapps.viewmodel.OcanViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.ocanF;

public class OcanFrag extends Fragment {

    private OcanViewModel mViewModel;
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;
    public static OcanFrag newInstance() {
        return new OcanFrag();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.ocan_fragment, container, false);
    }
    ...
    private void loadData() {
        ocanF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(OcanViewModel.class);
