...
import com.wallpaper.wally.alien.kodiapps.viewmodel.SuperHeroViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.superheroF;

public class SuperHeroFrag extends Fragment {

    private SuperHeroViewModel mViewModel;
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;
    public static SuperHeroFrag newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.super_hero_fragment, container, false);
    }
    ...
    private void loadData() {
        superheroF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(SuperHeroViewModel.class);
