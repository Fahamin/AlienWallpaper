...
import com.wallpaper.wally.alien.kodiapps.viewmodel.WaterViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.waterF;
...
public class WaterFrag extends Fragment {
    ...
    public static WaterFrag newInstance() {
    ...
    private void loadData() {
        waterF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(WaterViewModel.class);
