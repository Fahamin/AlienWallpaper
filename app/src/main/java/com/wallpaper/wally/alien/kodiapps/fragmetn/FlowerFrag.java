...
import com.wallpaper.wally.alien.kodiapps.viewmodel.FlowerViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.flowerF;

public class FlowerFrag extends Fragment {
    public static RecyclerView recyclerView;
    public static List<ImageModel> list;
    ImageAdapter adapter;
    private FlowerViewModel mViewModel;

    public static FlowerFrag newInstance() {
    ...
    private void loadData() {
        flowerF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(FlowerViewModel.class);
