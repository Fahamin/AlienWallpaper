...
import com.wallpaper.wally.alien.kodiapps.viewmodel.GameViewModel;

import java.util.ArrayList;
import java.util.List;

import static com.wallpaper.wally.alien.kodiapps.classfile.Utils.gameF;
...
public class GameFrag extends Fragment {
    ...
    private void loadData() {
        gameF.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
